...
# PEP 8 스타일 가이드에는 많은 내용이 있는데,
# 이 시점에서 모두 다루지는 않겠습니다.
# 당장 도움이 될 만한 몇 가지만 말씀드릴게요.
# 더 많은 내용을 알고 싶으신 분들은 PEP 8 원본 문서(PEP 8 – Style Guide for Python Code - https://peps.python.org/pep-0008/)를 참고해 주세요.
